...
8. In the Program Device Wizard, enter "\<archive extracted location\>vivado_proj/Arty-A7-100-Pmod-VGA.runs/impl_1/top.bit" into the "Bitstream file" field. Then click **Program**.
